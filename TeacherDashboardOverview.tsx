...
const RecentActivity = () => {
  const activities = [
    { id: 1, student: "Anshika Sharma", action: "Completed assignment", subject: "Mathematics", time: "2 hours ago" },
    { id: 2, student: "Rajesh Kumar", action: "Submitted peer review", subject: "Science", time: "3 hours ago" },
    { id: 3, student: "Priya Singh", action: "Achieved milestone", subject: "English", time: "5 hours ago" },
    { id: 4, student: "Amit Patel", action: "Started new module", subject: "History", time: "6 hours ago" },
  ];
...
const TopPerformers = () => {
  const topStudents = [
    { name: "Anshika Sharma", score: 95, xp: 2150, streak: 16 },
    { name: "Rajesh Kumar", score: 92, xp: 2080, streak: 12 },
    { name: "Priya Singh", score: 89, xp: 1950, streak: 8 },
    { name: "Amit Patel", score: 87, xp: 1890, streak: 15 },
    { name: "Neha Gupta", score: 85, xp: 1820, streak: 10 },
  ];
...
const AssignmentManagement = () => {
  const [assignments] = useState<Assignment[]>([
    { id: 1, title: "Mathematics Quiz", subject: "Math", dueDate: "2025-07-15", submissions: 28, total: 32, status: "active" },
    { id: 2, title: "Science Project", subject: "Science", dueDate: "2025-07-20", submissions: 15, total: 32, status: "active" },
    { id: 3, title: "English Essay", subject: "English", dueDate: "2025-07-12", submissions: 32, total: 32, status: "completed" },
    { id: 4, title: "History Research", subject: "History", dueDate: "2025-07-25", submissions: 8, total: 32, status: "draft" },
  ]);
...
const TeacherDashboardOverview = () => {
  ...
  const dashboardData = {
    ...
    highestStreakStudent: 'Anshika Sharma (16 days)',
    totalXP: '6,500 XP',
    activeStudents: 32,
    totalAssignments: 24,
    avgClassScore: '87%',
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#f9fafb', paddingLeft: '230px' }}>
      {/* Header */}
      <div style={{ 
        backgroundColor: '#ffffff', 
